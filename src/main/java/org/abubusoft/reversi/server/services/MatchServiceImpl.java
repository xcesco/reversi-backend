...
public class MatchServiceImpl implements MatchService, GameRenderer {
  ...
  public void render(GameSnapshot gameSnapshot) {
    ...
    applicationEventPublisher.publishEvent(new MatchStatusEvent(player1.getUserId(), player2.getUserId(), MatchStatus.of(getId(), gameSnapshot)));
  }
}
